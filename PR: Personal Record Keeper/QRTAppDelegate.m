...
#import "QRTAppDelegate.h"

@implementation QRTAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[UITabBar appearance] setTintColor:[UIColor colorWithRed:51/255.0 green:221/255.0 blue:236/255.0 alpha:1.0]];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"PRModel.sqlite"];
